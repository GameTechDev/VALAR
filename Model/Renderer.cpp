...
void Renderer::LoadPipelineStatistics()
{
    ...
    BufferDesc.Width = sizeof(D3D12_QUERY_DATA_PIPELINE_STATISTICS); //per frame begin and end timestamp plus pipeline statistics
    BufferDesc.Height = 1;
    ...
    g_Device->CreateCommittedResource(&HeapProps, D3D12_HEAP_FLAG_NONE, &BufferDesc, D3D12_RESOURCE_STATE_COPY_DEST, nullptr, IID_PPV_ARGS(&m_queryResult));
